...
class Recognizer {
  constructor(target, handlers, config, gestureKey, nativeHandlers) {
    this._target = target;
    this._gestureKey = gestureKey;
    this._ctrl = new Controller$1(handlers);
...
const img1 = "/arts/assets/1-small-d1183c0f.jpg";

const img2 = "/arts/assets/2-small-275848d5.jpg";

const img3 = "/arts/assets/3-small-36d86e9a.jpg";

const img4 = "/arts/assets/4-small-137b16bc.jpg";

const img5 = "/arts/assets/5-8cb28832.PNG";

const imgBig1 = "/arts/assets/1-320ec550.PNG";

const imgBig2 = "/arts/assets/2-87ab3c49.PNG";

const imgBig3 = "/arts/assets/3-28798fb4.PNG";

const imgBig4 = "/arts/assets/4-6268618b.PNG";
...
function createMeshes() {
	dataItems.forEach((o, index) => {
		...
		o.mesh = new Mesh(geometry, material);
		o.mesh.name = index;
...
//# sourceMappingURL=index-907698b1.js.map
